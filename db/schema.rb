...
ActiveRecord::Schema[7.1].define(version: 2024_08_03_194003) do
  ...
  create_table "donantes", force: :cascade do |t|
    ...
    t.boolean "candidato", default: false
    t.integer "cantidad_donaciones", default: 0
    t.boolean "suscripto", default: false
